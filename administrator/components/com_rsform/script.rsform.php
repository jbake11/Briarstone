...
.red {
	...
	<div id="installer-right">
		...
		<?php if ($messages['modules']) { ?>
			...
			<?php } ?>
		<?php } ?>
		<h2>Changelog v1.50.7</h2>
		<ul class="version-history">
			<li><span class="version-new">New</span> New {global:formid} placeholder that can be used in Form Layout.</li>
			<li><span class="version-new">New</span> Free Text fields will now show their value when using {FreeText:value}.</li>
			<li><span class="version-fixed">Fix</span> Some servers were double encoding form backups and caused issues in Google Chrome.</li>
			<li><span class="version-fixed">Fix</span> enctype="multipart/form-data" attribute no longer added automatically if form contains no upload fields.</li>
			<li><span class="version-fixed">Fix</span> Mappings now escapes the database name.</li>
		</ul>
